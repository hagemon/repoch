...
def conclude(language, date, overwrite=False):
    ...
    if not overwrite and os.path.exists(os.path.join(conclude_path, f"{language}.md")):
        print(f"{os.path.join(conclude_path, f'{language}.md')} already exists")
        return
